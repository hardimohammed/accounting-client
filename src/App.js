...
const QuotationListPage  = () => <Stub title="Quotations"          />;
const PurchaseOrderPage  = () => <Stub title="Purchase Orders"     />;
const AssetFormPage      = () => <Stub title="Asset Form"          />;
const ProjectDetailPage  = () => <Stub title="Project Detail"      />;
...
function RegisterPage() {
  ...
  const [error,   setError]   = React.useState('');
  const [form, setForm] = React.useState({
    orgName:'', fiscalYearStart:'2024-01-01',
    fiscalYearEnd:'2024-12-31', baseCurrency:'GHS',
